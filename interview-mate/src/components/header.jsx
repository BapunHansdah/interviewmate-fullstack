...
export default function Header(){
	return (
		   <div className="max-w-[1440px] bg-white flex justify-between items-center mx-auto px-3 py-5 shadow">
		     <div className="">
		       <div className="">
		     ...
		     <div className="hidden md:block">
		       <div className="flex gap-8">
		        <div className="text-sm font-semibold hover:text-gray-500 cursor-pointer py-2 px-1">Home</div>
		     	...
		     	<div className="text-sm font-semibold hover:text-white hover:bg-opacity-80 cursor-pointer bg-orange-500 py-2 px-1 rounded"><Link to="/signin">Sign up</Link></div>
		       </div>
		     </div>
		   </div>
		)
